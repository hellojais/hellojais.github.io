...
Zero constraint violations throughout. Latent changes bounded between 10^-9 and 10^-7 with no abrupt spikes — smooth evolution through the latent space rather than the sharp corrective jumps you would see in a repair-based system.
