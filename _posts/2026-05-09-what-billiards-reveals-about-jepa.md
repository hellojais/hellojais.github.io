...
excerpt: "I applied LeWM to 2D billiards and discovered a precise boundary condition for JEPA-based planning: the model learned ball position excellently (R²=0.988) but velocity poorly (R²=0.33). Four experiments, one key finding."
